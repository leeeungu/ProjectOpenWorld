...
{
	AIMoveComponent = CreateDefaultSubobject<UPalAIMoveComponent>(TEXT("AIMoveComponent"));
}
...
//
//// MoveTo에 의해 호출되는 함수
//void APalAIController::OnMoveCompleted(FAIRequestID RequestID, const FPathFollowingResult& Result)
//{
